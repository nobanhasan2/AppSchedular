...
tasks.register("runApp", Exec::class) {
    ...
    if (localProperties.exists()) {
        ...
        val applicationPackage = "com.noban.appschedular.${Default.BUILD_FLAVOR}.${Default.BUILD_TYPE}"
        val launchActivity = "com.noban.appschedular.core.navigation.RouteActivity"
