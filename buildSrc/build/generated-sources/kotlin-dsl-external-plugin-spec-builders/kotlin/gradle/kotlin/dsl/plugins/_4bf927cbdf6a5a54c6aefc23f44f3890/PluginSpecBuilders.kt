...
package gradle.kotlin.dsl.plugins._4bf927cbdf6a5a54c6aefc23f44f3890
...
/**
 * The `org.gradle.validate-external-gradle-plugin` plugin implemented by [org.gradle.plugin.devel.plugins.ExternalPluginValidationPlugin].
 */
internal
val `OrgGradlePluginGroup`.`validate-external-gradle-plugin`: PluginDependencySpec
    get() = plugins.id("org.gradle.validate-external-gradle-plugin")
