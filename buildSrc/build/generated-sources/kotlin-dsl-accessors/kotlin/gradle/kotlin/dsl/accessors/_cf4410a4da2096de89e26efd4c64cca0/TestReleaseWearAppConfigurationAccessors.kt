...
fun DependencyHandler.`testReleaseWearApp`(
    ...
    this, "testReleaseWearApp", group, name, version, configuration, classifier, ext, dependencyConfiguration
)
 ...
 */
internal
fun DependencyConstraintHandler.`testReleaseWearApp`(constraintNotation: Any, block: DependencyConstraint.() -> Unit): DependencyConstraint? =
