...
fun DependencyHandler.`releaseWearApp`(
    ...
    this, "releaseWearApp", group, name, version, configuration, classifier, ext, dependencyConfiguration
)
 ...
 */
internal
fun DependencyConstraintHandler.`releaseWearApp`(constraintNotation: Any, block: DependencyConstraint.() -> Unit): DependencyConstraint? =
